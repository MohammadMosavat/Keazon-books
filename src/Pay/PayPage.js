...
function getTimeCodeFromNum(num) {
  ...
  return `${String(hours).padStart(2, 0)}:${minutes}:${String(
    ...
    txtBookPay.append(titleBookPay,artistBookPay,typeBookPay,priceBookPay,saveBtnOrder,descBookPay)
    ...
    const clickSaveBtn = (saveBtnOrder) => {
       ...
       saveBtnOrder.addEventListener('click' , e => {
         ...
         if(finallResultCheck == 'matched'){
           ...
           alertProgram.children[0].innerHTML = 'This book already is saved!'
